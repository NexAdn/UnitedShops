...
public final class GUIContainer {
    ...
    {
        return getFunctionalItem(mat, (short) 0, display, funcLore);
    }

    public static ItemStack getFunctionalItem (Material mat, short damage, String display, String... funcLore)
    {
        ItemStack ret = new ItemStack(mat, 1, damage);
        if (mat != Material.AIR)
        {
